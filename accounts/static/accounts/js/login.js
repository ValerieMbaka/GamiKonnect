...
// Login page specific behaviors

// Firebase sign-in then submit to backend via fetch to handle JSON + toasts and conditional UI
	...
	loginForm.addEventListener('submit', async function(e){
		...
		try {
			...
			if (data.success) {
				...
				const redirectUrl = data.role === 'gamer' ? loginForm.dataset.gamerDashboardUrl : loginForm.dataset.shopOwnerDashboardUrl;
